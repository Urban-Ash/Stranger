# Stranger
Translations: [中文](README.zh-CN.md) | [繁體中文](README.zh-TW.md) | [日本語](README.ja.md) | [한국어](README.ko.md)
Note: This project is authored entirely by AI.

<p align="center">
  <img src="https://img.shields.io/badge/AI%20Authored-100%25-blueviolet?style=for-the-badge" alt="AI Authored 100%" />
  
</p>

An all-in-one OSINT aggregation and search system (frontend + backend). It offers a multilingual UI, data maintenance, source-detail inspection, validation queries, and optional AI confidence assessment.
...
- License TBD for internal use unless provided; add `LICENSE` if open-sourcing.